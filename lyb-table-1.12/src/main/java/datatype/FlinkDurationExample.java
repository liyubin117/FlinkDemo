...
/**
 * 项目名称: Apache Flink 知其然，知其所以然 - datatype 功能描述: Flink SQL INTERVAL 操作步骤:
 *
...
public class FlinkDurationExample {
    public static void main(String[] args) {
        ...
        // SQL逻辑
        String querySql =
                "SELECT hiredate  + INTERVAL '999' DAY(3), TO_TIMESTAMP(FROM_UNIXTIME(ts / 1000)) FROM datagen_source ";
