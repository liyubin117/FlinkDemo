...
public class HiveUDAF_sql_registry_create_temporary_function_Test {
    ...
    public static void main(String[] args) throws ClassNotFoundException, IOException {
        ...
        //  java.lang.UnsupportedOperationException: This CatalogFunction is a
        // InlineCatalogFunction. This method should not be called.
        //  因为 CREATE TEMPORARY FUNCTION 使用的是 inline catalog

        String sql2 =
                "CREATE TEMPORARY FUNCTION test_hive_udaf as 'flink.examples.sql._08.batch._03_hive_udf._01_GenericUDAFResolver2.TestHiveUDAF'";

        String sql3 =
                "select test_hive_udaf(user_id, '20210920')\n"
                        + "         , count(1) as part_pv\n"
