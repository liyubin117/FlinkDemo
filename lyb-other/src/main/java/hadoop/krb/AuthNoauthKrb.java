...
public class AuthNoauthKrb {
    public static void main(String[] args) throws IOException, ClassNotFoundException {
        //初始化认证集群配置文件
        String krbDir = System.getProperty("user.dir") + File.separator + "file" + File.separator + "krb";
...
//                        UserGroupInformation.reset();
        ...
        //初始化非认证配置文件
        String simpleDir = System.getProperty("user.dir") + File.separator + "file" + File.separator + "simple";
            ...
            try {
                while (true) {
                    synchronized ("A") {
                        ...
                        FileStatus[] files = fileSystem.listStatus(new Path("hdfs://slothTest/user/sloth/lyb"));
                        for (FileStatus file : files) {
