...
/** hbase-client 异步提交 An example of using the {@link BufferedMutator} interface. */
                        ...
                        workerPool.submit(
                                new Callable<Void>() {
                                    ...
                                    public Void call() throws Exception {
                                        ...
                                        // the same backing buffer, call-back "listener", and RPC
                                        // executor pool.
                                        //
                                        //                        Put p = new
                                        // Put(Bytes.toBytes("someRow"));
                                        ...
                                        mutator.mutate(p);
                                        mutator.flush();
                                        // do work... maybe you want to call mutator.flush() after
                                        // many edits to ensure any of
                                        ...
                                        for (Cell cell : result.rawCells()) {
                                            System.out.print(
                                                    "行健: " + new String(CellUtil.cloneRow(cell)));
                                            System.out.print(
                                                    "\t列簇: "
                                                            + new String(
