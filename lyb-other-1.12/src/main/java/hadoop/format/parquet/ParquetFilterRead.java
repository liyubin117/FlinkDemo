...
public class ParquetFilterRead {
    ...
    public static void main(String args[]) throws IOException {
        ...
        // set reader, withConf set specific fields (requested projection), withFilter set the
        // filter.
        ...
        Group line;
        while ((line = build.read()) != null) System.out.println(line.toString());
    }
}
