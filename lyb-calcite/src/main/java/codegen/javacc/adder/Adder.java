...
public class Adder implements AdderConstants {
    ...
    /* 语法分析器 */
    public final double evaluate() throws ParseException, NumberFormatException {
        trace_call("evaluate");
        try {
            double i;
            double value;
    ...
    public final double primary() throws ParseException {
        trace_call("primary");
        try {
            Token t;
    ...
    protected void trace_token(Token t, String where) {
        if (trace_enabled) {
            ...
            System.out.println(
                    " at line " + t.beginLine + " column " + t.beginColumn + ">" + where);
        }
    }
