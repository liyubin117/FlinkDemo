...
/** 服务端 create 't2','f1','f2' 输入数据格式（行键|列族,列,值:列族,值,...） rk1|f1,c1,v1:f2,c2,v2 */
public class TestHBaseSqlSink {
    ...
    public void test() {
        ...
        HBaseSink hbaseSink =
                new HBaseSink<ArrayList<ArrayList<String>>>("t2", p) {
                    @Override
                        ...
                        try {
                            ...
                            if (rowKey != "!!!error input!!!") {
                                ...
                                for (int i = 0; i < value.size(); i++) {
                                    ...
                                    if (3 == size) {
                                        put.addColumn(
                                                Bytes.toBytes(subList.get(0).toString()),
        ...
        DataStream<ArrayList<ArrayList<String>>> text =
                socketStream.map(
                        new MapFunction<String, ArrayList<ArrayList<String>>>() {
                            @Override
