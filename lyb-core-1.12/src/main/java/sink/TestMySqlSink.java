...
public class TestMySqlSink {
    ...
    public void test() {
        // mysql连接信息
        MySqlSink mysqlSink =
                new MySqlSink<Tuple4<String, Integer, String, String>>(
                    ...
                    @Override
                    public void invoke(Tuple4<String, Integer, String, String> value)
                            throws Exception {
        ...
        DataStream<Tuple4<String, Integer, String, String>> text =
                socketStream.map(
                        new MapFunction<String, Tuple4<String, Integer, String, String>>() {
                            @Override
                            public Tuple4<String, Integer, String, String> map(String s)
                                    throws Exception {
                                // 可以加一些必要的字段分隔、字段校验
                                ...
                                if (cols.length == 4) {
                                    return new Tuple4(
                                            ...
                                            Integer.valueOf(cols[1]),
                                            String.valueOf(cols[2]),
