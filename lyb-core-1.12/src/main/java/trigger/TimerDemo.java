...
public class TimerDemo {
    ...
    public static class TimerProcessFuntion
        ...
        public void onTimer(long timestamp, OnTimerContext ctx, Collector<Object> out)
                throws Exception {
            System.out.println(
                    "-----调用 Timer-----" + ctx.getCurrentKey() + "\t" + new Date(timestamp));
        ...
        /**
         * 用户是否对该订单进行了评价，在生产环境下，可以去查询相关的订单系统. 我们这里只是随便做了一个判断
         *
         * @param key
         * @return
         */
        ...
        @Override
        public void processElement(Tuple2<String, Long> value, Context ctx, Collector<Object> out)
                throws Exception {
